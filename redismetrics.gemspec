# -*- encoding: utf-8 -*-
# stub: redismetrics 0.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [".all_images.yml".freeze, ".envrc".freeze, ".gitignore".freeze, ".semaphore/semaphore.yml".freeze, ".tool-versions".freeze, ".utilsrc".freeze, "Gemfile".freeze, "LICENSE".freeze, "README.md".freeze, "Rakefile".freeze, "VERSION".freeze, "config/redis.conf".freeze, "docker-compose.yml".freeze, "lib/redismetrics.rb".freeze, "lib/redismetrics/client.rb".freeze, "lib/redismetrics/labels.rb".freeze, "lib/redismetrics/middleware/sidekiq.rb".freeze, "lib/redismetrics/version.rb".freeze, "redismetrics.gemspec".freeze, "spec/labels_spec.rb".freeze, "spec/redismetrics/client_spec.rb".freeze, "spec/redismetrics_spec.rb".freeze, "spec/spec_helper.rb".freeze]
  ...
  s.test_files = ["spec/labels_spec.rb".freeze, "spec/redismetrics/client_spec.rb".freeze, "spec/redismetrics_spec.rb".freeze, "spec/spec_helper.rb".freeze]
